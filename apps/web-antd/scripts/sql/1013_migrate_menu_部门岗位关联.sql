...
DECLARE @menu_id UNIQUEIDENTIFIER = 'A1000001-0001-4001-8001-000000000123';        -- 部门岗位关联
...
BEGIN
  ...
  VALUES
    (
      @menu_id,
      N'部门岗位关联',
      N'/dept-post/dep-rank',
      N'hr/dep-rank/index',
      N'{"icon":"mdi:source-branch","title":"部门岗位关联","query":{"menuid":"A1000001-0001-4001-8001-000000000123"}}',
      @parent_menu_id,
      1,
      N'menu',
      123
...
BEGIN
  ...
  SET name = N'部门岗位关联',
      path = N'/dept-post/dep-rank',
      component = N'hr/dep-rank/index',
      meta = N'{"icon":"mdi:source-branch","title":"部门岗位关联","query":{"menuid":"A1000001-0001-4001-8001-000000000123"}}',
      parent_id = @parent_menu_id,
      status = 1,
      type = N'menu',
      sort = ISNULL(sort, 123)
  WHERE id = @menu_id;
END
